...
1. Отредактируй его бинд
 > *к слову:* это только лишь копирует файл в директорию `res/sounds/` и добавляет в `sounds.map`, а не использует его в изначальной директории оригинального файла
### Изменение биндов
